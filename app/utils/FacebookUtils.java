...
public class FacebookUtils extends Job {
	private DiscountCoupon coupon;
	public FacebookUtils(DiscountCoupon coupon){
		this.coupon=coupon;
	}
	@Override
    public void doJob() throws Exception {
		shareCouponOnFacebook();
	}
	public void shareCouponOnFacebook() throws UnsupportedEncodingException{
